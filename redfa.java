...
public class redfa extends OpMode {
    ...
    PathState pathState;
    private final Pose startPose = new Pose(87.97500000000001, 8.549999999999978, Math.toRadians(90));
    private final Pose shootPose = new Pose(87.97500000000001, 35.623693379790936, Math.toRadians(66));
    private final Pose drivebackload1 = new Pose(95.84668989547038, 35.623693379790936, Math.toRadians(0));
    private final Pose driveforthload1 = new Pose(127.44250871080139, 35.623693379790936, Math.toRadians(0));
    private final Pose driveback2load1 = new Pose(87.97500000000001, 35.623693379790936, Math.toRadians(66));
    private final Pose driveforthshootload1 = new Pose(88.13937282229965, 59.18118466898957, Math.toRadians(0));
    private final Pose driveback1load2 = new Pose(125.27526132404181, 59.268292682926834, Math.toRadians(0));
    private final Pose driveforthload2 = new Pose(88.33101045296168, 59.024390243902424, Math.toRadians(59));
    private final Pose driveback2load2 = new Pose(88.55749128919861, 83.0383275261324, Math.toRadians(0));
    private final Pose driveforthshootload2 = new Pose(124.9163763066202, 83.98257839721254, Math.toRadians(0));
    private final Pose leave = new Pose(88.57142857142857, 82.8362369337979, Math.toRadians(50));
    private final Pose leavefinal = new Pose(105.93379790940766, 70.98954703832752, Math.toRadians(0));
    private PathChain driveStartPosShootPos, drivebackloadball1, driveforthloadball1, driveback2loadball1, driveforthshootloadball1, driveback1loadball2, driveforthloadball2, driveback2loadball2, driveforthshootloadball2, leaveball, leavefinalball;
    ...
    public void buildPaths() {
        ...
        leaveball = follower.pathBuilder()
                ...
                .build();
        leavefinalball = follower.pathBuilder()
                .addPath(new BezierLine(leave, leavefinal))
                .setLinearHeadingInterpolation(leave.getHeading(), leavefinal.getHeading())
                .build();
    }
        ...
        switch (pathState) {
            ...
            case LEAVEEND:
                if (!follower.isBusy()) {
                    ...
                    servolid.setPosition(0.8);//opened lid
                    intakequickshots(); //intake
                    follower.followPath(leavefinalball, true);
                    setPathState(PathState.LEAVEFINAL);
                    telemetry.addLine("Done path 9");
                }
            case LEAVEFINAL:
                if (!follower.isBusy()) {
