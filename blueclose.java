...
public class blueclose extends OpMode {
    ...
    PathState pathState;
    private final Pose startPose = new Pose(34.42499999999999, 135.22500000000008, Math.toRadians(270));
    private final Pose shootPose = new Pose(38.24999999999999, 105.52500000000003, Math.toRadians(130));
    private final Pose drivebackload1 = new Pose(47.42499999999999, 83.85, Math.toRadians(180));
    private final Pose driveforthload1 = new Pose(22.05, 83.7, Math.toRadians(180));
    private final Pose driveback2load1 = new Pose(47.42499999999999, 83.85, Math.toRadians(180));
