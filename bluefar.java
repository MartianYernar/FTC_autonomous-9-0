...
public class bluefar extends OpMode {
    ...
    PathState pathState;
    private final Pose startPose = new Pose(56.25, 8.549999999999994, Math.toRadians(90));
    private final Pose shootPose = new Pose(55.349999999999994, 35.32499999999995, Math.toRadians(113));
    private final Pose drivebackload1 = new Pose(46.00000000000001, 35.32499999999995, Math.toRadians(180));
    private final Pose driveforthload1 = new Pose(17.575, 35.32499999999995, Math.toRadians(180));
    private final Pose driveback2load1 = new Pose(55.349999999999994, 35.32499999999995, Math.toRadians(113));
    private final Pose driveforthshootload1 = new Pose(38.24999999999999, 105.52500000000003, Math.toRadians(130));
    private final Pose driveback1load2 = new Pose(45.349999999999994, 59.525, Math.toRadians(180));
    private final Pose driveforthload2 = new Pose(22.525000000000002, 59.525, Math.toRadians(180));
    private final Pose driveback2load2 = new Pose(45.349999999999994, 59.525, Math.toRadians(180));
    private final Pose driveforthshootload2 = new Pose(38.24999999999999, 105.52500000000003, Math.toRadians(130));
    private final Pose leave = new Pose(19.975000000000005, 95.62500000000001, Math.toRadians(180));
